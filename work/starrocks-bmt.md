...
- [ ] RGW(radosgw) 자체의 동시 커넥션/스레드 설정이 동시성 병목의 원인인지 확인 — "FE를 늘려도 안 됨"까지는 확인했지만 RGW 쪽 튜닝은 아직 안 해봄
...
- [`16-add-fe-followers.sh`](../scripts/08-starrocks/16-add-fe-followers.sh) — FE Follower 추가(코디네이터 분산 실험)
