...
echo "== chan 계정을 libvirt/kvm 그룹에 추가 =="
usermod -aG libvirt,kvm chan
...
echo "== chan 계정 기본 libvirt URI를 qemu:///system으로 고정 =="
# chan 계정으로 virsh를 sudo 없이 실행하면 기본값이 qemu:///session(사용자별,
...
EOF
chown -R chan:chan /home/chan/.config/libvirt
